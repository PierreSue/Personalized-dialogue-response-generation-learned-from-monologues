...
def parse():
    ...
    parser.add_argument("--model-dir", type=str, default='results/stargan')
    parser.add_argument("--pretrain-dir", type=str, default='results/pretrain')
    parser.add_argument("--stargan-dir", type=str, default='results/stargan')
    
    parser.add_argument("--glove-model", type=str, default='glove_model/corpus_op+fri')
    
    parser.add_argument("--data-dir", type=str, default='data/')
    parser.add_argument("--data-path", type=str, default='data/train_opensubtitle.txt')

    parser.add_argument("--feature-path", type=str, default='data/feature.txt')
    parser.add_argument("--feature-size", type=int, default=6)

    parser.add_argument("--train-path", type=str, default='data/friends_pretrain.txt')
    
    parser.add_argument("--test-path", type=str, default='data/friends_pretrain.txt')
